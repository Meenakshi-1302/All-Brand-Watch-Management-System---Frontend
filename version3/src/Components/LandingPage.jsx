...
//             {/* Logo */}
//             <img src="/showroomlogo.jpg" alt="WatchMania Logo" className="h-10" />
...
//           {/* Watch Card Example */}
//           <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl cursor-pointer">
//             <img src="casual_watch.webp" alt="Watch 1" className="w-full h-64 object-cover" />
//             <div className="p-6">
//               <h3 className="text-xl font-semibold mb-2">Timex Casual-Wear Watch</h3>
//               <p className="text-gray-700 mb-4">Perfect for everyday wear.</p>
...
//             </div>
//           <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl cursor-pointer">
//             <img src="couple_watch.webp" alt="Watch 1" className="w-full h-64 object-cover" />
//             <div className="p-6">
//               <h3 className="text-xl font-semibold mb-2">Fastrack Couple Watch</h3>
//               <p className="text-gray-700 mb-4">Forever Together, Timeless Elegance for You and Me.</p>
//               <p className="text-lg font-bold mb-4">$99.99</p>
//               <a href="/login" className="bg-blue-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-600">View Details</a>
//             </div>
//           </div>
//           <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl cursor-pointer">
//             <img src="classic_watch.jpg" alt="Watch 1" className="w-full h-64 object-cover" />
//             <div className="p-6">
//               <h3 className="text-xl font-semibold mb-2">Sonata Classic Watch</h3>
//               <p className="text-gray-700 mb-4">Perfect for everyday wear.</p>
//               <p className="text-lg font-bold mb-4">$99.99</p>
//               <a href="/login" className="bg-blue-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-600">View Details</a>
//             </div>
//           </div>
//           <div className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl cursor-pointer">
//             <img src="sports_watch.jpg" alt="Watch 1" className="w-full h-64 object-cover" />
//             <div className="p-6">
//               <h3 className="text-xl font-semibold mb-2">SMAEL Sports-Wear Watch</h3>
//               <p className="text-gray-700 mb-4">Gear Up for Victory, Precision Timing for Every Challenge.</p>
//               <p className="text-lg font-bold mb-4">$99.99</p>
//               <a href="/login" className="bg-blue-500 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-600">View Details</a>
//             </div>
//           </div>
//           {/* Additional Watch Cards */}
//         </div>
//       </section>
