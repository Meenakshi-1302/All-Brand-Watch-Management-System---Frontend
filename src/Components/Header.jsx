...
export default Header;
//---------------trail foe session storage---------
// import React from 'react';
// import { useCart } from 'react-use-cart'; // Import useCart hook
// import { FaShoppingCart, FaHome, FaUser, FaListAlt } from 'react-icons/fa';
// import { MdOutlineContactSupport, MdExitToApp } from 'react-icons/md';
// import { useNavigate } from 'react-router-dom';
...
//                 <FaListAlt className="w-6 h-6 mr-3 text-blue-300" />
//               </a>
//             </li>
//             <li>
//               <a href="/contact-page" className="hover:underline">
...
//     // Clear cart items from the cart context
//     localStorage.removeItem('cartItems'); // Clear cart items from localStorage if applicable

//     // Handle additional logout logic here if necessary (e.g., clear auth tokens, etc.)
